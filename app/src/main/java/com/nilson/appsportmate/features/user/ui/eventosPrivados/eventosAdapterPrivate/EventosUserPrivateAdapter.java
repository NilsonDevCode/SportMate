...
public class EventosUserPrivateAdapter extends RecyclerView.Adapter<EventosUserPrivateAdapter.VH> {
    ...
    public EventosUserPrivateAdapter(
    ...
    public VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_eventos_user_private, parent, false);
        return new VH(v);
    }
    ...
    public void onBindViewHolder(@NonNull VH h, int position) {
        ...
        // Datos
        String idDoc     = safeStr(ev.get("idDoc"));
